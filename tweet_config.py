...
COLS = ['id','type', 'created_at', 'source', 'original_text','clean_text','favorite_count', 'retweet_count', 'hashtags','mentions', 'original_author']

print(f"Authorizing Twitter; Initialize Tweepy")

...
class Retweet_Grabber(object):
	...
	def __init__(self, screen_name,input_file, *args, **kwargs):
        ...
        # Load the old tweets of the user to find the position from which the new tweets are to be appended
	...
	def get_old_retweets(self):
		...
		if exists:
            ...
            # If some tweets have already been collected
            ...
            # Find the new tweets to be collected by dropping out the tweets already collected
        ...
        # If the file is empty then initiaize this array as follows  
	...
	def put_tweets(self):
        ...
        # Extract the retweets which are within our date span
	...
	def get_user_retweets(self):
		...
		for _, row in self.tweet_ids.iterrows():
            ...
            # The twitter API allows only the retweets of 75 tweets at time and afterwards an error is thrown.To stop this we premptively stop once 75 tweets arecollected
			if index % 74 == 0:
